...
location_table: Dict[str, FNaFB2LocationData] = {
    ...
    **{f"Mangle - Level {i + 1}":                                         FNaFB2LocationData("Levelsanity", 766783_178 + i) for i in range(20)}, 
    ...
    "Toy Freddy - Use Tophat Slash 20 times":                             FNaFB2LocationData("Grindy", 766783_202),
    "Toy Freddy - Use Tophat Slash 40 times":                             FNaFB2LocationData("Grindy", 766783_203),
    "Toy Freddy - Use Tophat Dash 20 times":                              FNaFB2LocationData("Grindy", 766783_204),
    "Toy Freddy - Use Tophat Dash 40 times":                              FNaFB2LocationData("Grindy", 766783_205),
    "Toy Freddy - Use Tophat Crash 20 times":                             FNaFB2LocationData("Grindy", 766783_206),
    "Toy Freddy - Use Tophat Crash 40 times":                             FNaFB2LocationData("Grindy", 766783_207),
    "Toy Freddy - Use Tophat Smash 20 times":                             FNaFB2LocationData("Grindy", 766783_208),
    "Toy Freddy - Use Tophat Smash 40 times":                             FNaFB2LocationData("Grindy", 766783_209),
