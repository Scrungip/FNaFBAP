...
location_groups: Dict[str, str] = {
    ...
    "Chests": {"Show Stage - Left Chest",
               ...
               "Backroom - Chest"},
    "Trades": {"Show Stage - Trade Alpha Voucher",
               "Show Stage - Trade Beta Voucher",
               "Show Stage - Trade Gamma Voucher",
               "Show Stage - Trade Omega Voucher"},
    "Interior Walls Trades": {"Show Stage - Trade Spades Voucher",
                              "Show Stage - Trade Hearts Voucher",
                              "Show Stage - Trade Diamonds Voucher",
                              "Show Stage - Trade Clubs Voucher"},
    "Interior Walls": {*{f"Interior Walls - Chest {i+1}" for i in range(0, 29)}},
    "Bosses": {"Show Stage - Toy Freddy",
               "Backroom - Toy Bonnie",
               "Restrooms - Toy Chica",
               "Pirate Cove - Mangle",
               ...
               "Backroom - The Mirror"},
    "Backroom BB Shop": {*{f"Backroom BB - Item {i+1}" for i in range(0, 6)}},
    "Restrooms BB Shop": {*{f"Restrooms BB - Item {i+1}" for i in range(0, 8)}},
    "Supply Closet BB Shop": {*{f"Supply Closet BB - Item {i+1}" for i in range(0, 10)}},
    "East Hall Corner BB Shop": {*{f"East Hall Corner BB - Item {i+1}" for i in range(0, 12)}},
    "Cameras": {"Show Stage - Camera",
                "Dining Area - Camera",
                "Backroom - Camera",
                "West Hall - Camera",
                "East Hall - Camera",
                ...
                "East Hall Corner - Camera",
                "West Hall Corner - Camera"},
    "Party Hats": {"Backroom - Alpha Party Hat",
                   "Restrooms - Beta Party Hat",
                   "Supply Closet - Gamma Party Hat",
                   "East Hall Corner - Omega Party Hat"},
    "Freddy Levels": {*{f"Freddy- Level {i+1}" for i in range(0, 20)}},
    "Bonnie Levels": {*{f"Bonnie- Level {i+1}" for i in range(0, 20)}},
    "Chica Levels": {*{f"Chica- Level {i+1}" for i in range(0, 20)}},
    "Foxy Levels": {*{f"Foxy- Level {i+1}" for i in range(0, 20)}},
    "Scrungip": {"Backroom - Scrungip",
                 "Dining Area - Scrungip",
