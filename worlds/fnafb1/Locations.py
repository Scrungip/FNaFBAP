...
location_table: Dict[str, FNaFB1LocationData] = {
    ...
    # Trade-Ins
    "Dining Area - Trade Alpha Voucher":                                  FNaFB1LocationData("Trade",   756783_009),
    "Dining Area - Trade Beta Voucher":                                   FNaFB1LocationData("Trade",   756783_010),
    "Dining Area - Trade Gamma Voucher":                                  FNaFB1LocationData("Trade",   756783_011),
    "Dining Area - Trade Omega Voucher":                                  FNaFB1LocationData("Trade",   756783_012),
    "Dining Area - Trade Spades Voucher":                                 FNaFB1LocationData("TradeIW",   756783_013),
    "Dining Area - Trade Hearts Voucher":                                 FNaFB1LocationData("TradeIW",   756783_014),
    "Dining Area - Trade Diamonds Voucher":                               FNaFB1LocationData("TradeIW",   756783_015),
    "Dining Area - Trade Clubs Voucher":                                  FNaFB1LocationData("TradeIW",   756783_016),
    #Interior Walls
