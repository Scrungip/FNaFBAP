...
item_groups: Dict[str, str] = {
    "Party Members": {"Freddy",
                      "Bonnie",
                      "Chica",
                      "Foxy"},
    "Weapons": {"Progressive Microphone",
                "Progressive Guitar",
                "Progressive Cupcakes",
                "Progressive Hook",
                "Progressive Dragon Dildo"},
    "Skills": {"Tophat Toss",
               "Lead Stinger",
               "Toreador March",
               "Bunny Hop",
               ...
               "Bonbon Combo",
               "Pirate Combo"},
    "Armor": {"Progressive Body Endoskeletons",
              "Progressive Head Endoskeletons",
              "Progressive Pizza Shields",
              "Progressive Caffeine Sodas",
              "Lucky Soda",
              "Double Pizza",
              "Ice Water",
              "Sneaky Juice",
              ...
              "Lunate Wine",
              "Thrifty Pretzels"},
    "General Progression": {"Lighter",
                            "Bonnie's Head Voucher",
                            "Bonnie's Head",
                            "Kitchen Key",
                            "Reveal Interior Walls",
                            "Office Key Piece",
                            "Backroom BB",
                            "Restrooms BB",
                            "Supply Closet BB",
                            "East Hall Corner BB",
                            "Funky Scrungip Token"},
    "Junk": {"Small Pizza",
             "Medium Pizza",
             "Large Pizza",
             "Small Soda",
             ...
             "Attack Boost",
             "Defense Boost",
             "Bonus Interior Walls Key",
             "100 Tokens",
             "500 Tokens"},
    "Cross World Items": {"1-Up Mushroom",
                          "Hylian Shield",
                          "Chaos Emerald",
                          "Dreamer's Crown",
                          "Blade",
                          ...
                          "1 Puzzle Piece",
                          "P",
                          "Star Fox Credits Theme",
                          "Scooby Snack",
                          "Anime catboy transformation potion",
                          "Lava Badge",
                          "The Fog is Coming",
                          "A Whole Chunk",
                          "Eggplant",
