...
location_table: Dict[str, FNaFBLocationData] = {
    ...
    "Dining Area - Trade Spades Voucher":                                 FNaFBLocationData("Trade",   756783_013),
    "Dining Area - Trade Hearts Voucher":                                 FNaFBLocationData("Trade",   756783_014),
    "Dining Area - Trade Diamonds Voucher":                               FNaFBLocationData("Trade",   756783_015),
    "Dining Area - Trade Clubs Voucher":                                  FNaFBLocationData("Trade",   756783_016),
    #Interior Walls
