...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "D:/mkxp-z/windows/build-mingw64")
  ...
  CONFIG["configure_args"] = " '--prefix=/d/mkxp-z/windows/build-mingw64' '--prefix=D:/mkxp-z/windows/build-mingw64' '--enable-install-static-library' '--disable-install-doc' '--with-openssl-dir=' '--without-ext=openssl,readline,dbm,gdbm,win32ole' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'CC=gcc' 'CFLAGS=-flto -I/d/mkxp-z/windows/build-mingw64/include -O3' 'LDFLAGS=-flto -L/d/mkxp-z/windows/build-mingw64/lib'"
  ...
  CONFIG["DLDFLAGS"] = "-flto -L/d/mkxp-z/windows/build-mingw64/lib -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc.exe (Rev5, Built by MSYS2 project) 13.2.0\nCopyright (C) 2023 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["LDFLAGS"] = "-L. -flto -L/d/mkxp-z/windows/build-mingw64/lib -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-flto -I/d/mkxp-z/windows/build-mingw64/include -O3"
